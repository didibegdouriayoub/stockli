...
export default defineConfig({
  ...
  // نفس الإعداد لمعاينة النسخة المبنية (npm run preview -- --host) — أخف
  // وأسرع بكثير على الهاتف من npm run dev لأنها ملفات مبنية ومصغَّرة بدل
  // مئات الوحدات غير المجمَّعة، فهي الأقرب لتجربة المستخدم الحقيقية.
  preview: {
    host: true,
  },
})
